...
//Part Shafiq
  ...
  elseif ($user == "Shafiq")
  {
    ...
    {
      $remainingAmt = $data[1][1] - $payment; //Part Alifah
  ...
  elseif ($user == "Ibad")
  {
    ...
    {
      $remainingAmt = $data[2][1] - $payment; //Part Alifah
  ...
  elseif ($user == "Alifah")
  {
    ...
    {
      $remainingAmt = $data[3][1] - $payment; //Part Alifah
  ...
  elseif ($user == "Muzafar")
  {
    ...
    {
      $remainingAmt = $data[4][1] - $payment; //Part Alifah
